        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="mb-0">Perfil de {{ $profile->first_name }} {{ $profile->last_name }}</h4>
                    <div>
                        @can('update', $profile)
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-4 text-center mb-4">
                            @if($profile->photo)
                                <img src="{{ Storage::url($profile->photo) }}" 
                                     alt="Foto de {{ $profile->first_name }}" 
                        ...
                        <div class="col-md-8">
                            <h2 class="mb-3">{{ $profile->first_name }} {{ $profile->last_name }}</h2>
                            
                            <div class="row mb-3">
                                <div class="col-sm-4"><strong>DNI:</strong></div>
                                <div class="col-sm-8">{{ $profile->dni }}</div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-8">{{ $profile->created_at->format('d/m/Y') }}</div>
                            </div>
                        </div>
                    </div>
