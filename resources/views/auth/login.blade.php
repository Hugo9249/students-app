...
<div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8">
        ...
        <div class="text-center">
            ...
            <p class="text-gray-600">Ingresa a tu cuenta de StudentApp</p>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
            <form class="space-y-6" method="POST" action="{{ route('login') }}">
                ...
                <div>
                    <button 
                        type="submit" 
                        class="w-full flex justify-center py-3 px-4 border border-transparent rounded-lg shadow-sm text-white bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all duration-200 font-medium"
                    >
        ...
        <div class="grid grid-cols-3 gap-4 mt-8">
            <div class="text-center">
                ...
                <p class="text-xs text-gray-600">Gestión Académica</p>
            </div>
            <div class="text-center">
                ...
                <p class="text-xs text-gray-600">Reportes</p>
            </div>
            <div class="text-center">
                ...
                <p class="text-xs text-gray-600">Colaboración</p>
            </div>
        </div>
    </div>
</div>
